...
# two compartment neuron were dendrite acts as ion buffer
cfg.somaR = 10  # um
cfg.dendR = 2.5  # um
cfg.dendL = 200  # um

# required dendrite volume to give neuronal volume fraction
total_dendrtic_volume = (
    cfg.betaNrn * cfg.Vtissue - cfg.Ncell * np.pi * cfg.somaR**3
) / cfg.Ncell

# volume scaling to give required volume fraction
cfg.dend_volume_fraction = total_dendrtic_volume / (np.pi * cfg.dendL * cfg.dendR**2)
